...
En esta sección se incluyen las herramientas y tecnologías utilizadas para el desarrollo del \ac{TFG}.
	...
	\subsection{Herramientas, tecnologías y frameworks para el desarrollo}
		...
		\subsubsection{Rspec}
		Rspec es una libreria para Ruby diseñada para la realización de pruebas. Actualmente es una de las herramientas más populares para este cometido en Ruby.
		...
		Es el navegador web por defecto de Elementary OS. Se utilizará para el acceso a la aplicación web.
	...
	\subsection{Herramientas documentales}
		...
		TexMaker es un editor gráfico para lenguaje LaTex distribuido bajo licencia \textit{\ac{GPL}}.
		...
		\ac{GIMP} es un editor de imágenes libre y gratuito. Se utilizará para la modificación, edición y creación de imágenes para el presente \ac{TFG}.
